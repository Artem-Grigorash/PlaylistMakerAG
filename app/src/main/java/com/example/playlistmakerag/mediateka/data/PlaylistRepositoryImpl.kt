...
import com.example.playlistmakerag.mediateka.domain.models.db.PlaylistRepository
...
class PlaylistRepositoryImpl(
    ...
    override suspend fun deletePlaylist(playlist: Playlist) {
        playlistDatabase.playlistDao().deleteTrackEntity(playlistDbConvertor.map(playlist))
    }
